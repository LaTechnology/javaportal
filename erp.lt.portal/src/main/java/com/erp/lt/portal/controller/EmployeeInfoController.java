...
public class EmployeeInfoController {
	...
	@GetMapping(path = ERPConstants.EMPLOYEE_GETNAME_URL)
	public List<EmployeeInfoVO> getEmployeeName(@PathVariable(value = "firstname") String firstname) {
		return employeeinfoservice.getEmployeeInfoByEmployeeName(firstname);
