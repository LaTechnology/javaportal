...
export class EmployeeEducationListComponent implements OnInit {
  ...
  constructor(private employeeService: EmployeeEducationService,
  ...
  reloadData() {
    this.employeesEducation = this.employeeService.getEmployeesEducationList();
  }

  deleteEmployee(id: number) {
    this.employeeService.deleteEmployeeEducation(id)
      .subscribe(
        data => {
          console.log(data);
          this.reloadData();
